...
class WerehouseProduct(models.Model):
    werehouse = models.ForeignKey(Werehouse, on_delete=models.CASCADE, related_name="w_products")
    product = models.ForeignKey(Product, on_delete=models.CASCADE, related_name="p_werehouse")
